...
const base = {
  ...
  onboarding: {
    ...
    clubCreate: {
      ...
      cta: '{{name}} anlegen',
      noMatch:
        'Keine Treffer auf öffentliche Quelle. Du kannst deinen Verein trotzdem manuell anlegen.',
      scraperOffline:
        'öffentliche Quelle-Suche ist gerade nicht verfügbar. Gib den Vereinsnamen ein, um manuell fortzufahren.',
    },
    clubIdentity: {
