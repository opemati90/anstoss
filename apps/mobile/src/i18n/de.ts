...
const base = {
  ...
  home: {
    ...
    importedMatchPendingTitle: 'Lizenzierter Spielplan-Feed verbunden',
    importedMatchPendingBody:
      'Wir warten auf den nächsten Termin aus dem autorisierten Feed.',
    importedMatchErrorTitle: 'Lizenzierter Feed braucht Aufmerksamkeit',
    importedMatchErrorBody:
      'Der autorisierte Feed konnte zuletzt nicht synchronisiert werden. Öffne die Spielplanquelle und versuche es erneut.',
    importedMatchEmptyTitle: 'Kein lizenzierter Spielplan-Feed verbunden',
    importedMatchEmptyBody:
      'Speichere die offizielle Teamseite als Referenz und erfasse Termine manuell, bis ein autorisierter Feed verfügbar ist.',
  ...
  fussball: {
    ...
    title: 'FUSSBALL.DE-Teamlink',
    subtitle: 'Speichere die offizielle öffentliche Teamseite für {{team}} und öffne sie direkt in Anstoss.',
    linkTitle: 'Offizielle Teamseite speichern',
    linkBody:
      'Füge einen direkten Team-Link von Fussball.de, DFB.de oder FuPa ein. Die Seite dient nur als Referenz, bestätigt keine Vereinsberechtigung und importiert keine Mitgliederdaten.',
    ...
    loadError: 'Die externe Teamdaten-Daten konnten gerade nicht geladen werden.',
    inputRequired: 'Bitte zuerst eine externe Teamdaten-URL oder Team-ID einfügen.',
    previewErrorTitle: 'Team konnte nicht geprüft werden',
    previewErrorBody: 'Die externe Teamdaten-Teamseite konnte gerade nicht geladen werden.',
    ...
    syncErrorBody: 'Der verknüpfte externe Teamdaten-Feed konnte gerade nicht aktualisiert werden.',
    ...
    noTeamBody:
      'Wähle zuerst eine Mannschaft aus, bevor du einen externe Teamdaten-Feed verknüpfst.',
    noLinksTitle: 'Noch keine Feeds verknüpft',
    noLinksBody:
      'Speichere hier die offizielle Teamseite. Bis ein lizenzierter Feed verfügbar ist, legst du Spiele manuell an.',
  ...
  matches: {
    ...
    openFussball: 'Auf öffentliche Quelle öffnen',
  ...
  more: {
    ...
    fussballLinkSubtitle: 'Öffentliche Seite als Referenz speichern; lizenzierte Feeds werden separat synchronisiert',
  ...
  onboarding: {
    ...
    clubCreate: {
      ...
      officialTeamUrlHelp: 'Füge die offizielle Teamseite als Kontext für die Plattformprüfung ein. Der Link beweist keine Vereinsberechtigung.',
  ...
  dm: {
    ...
    restricted: 'Zum Schutz Minderjähriger sind private Nachrichten nur mit verknüpften Erziehungsberechtigten möglich.',
  },
  myTeam: {
    title: 'Mein Team',
