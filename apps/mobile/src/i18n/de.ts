...
const base = {
  ...
  home: {
    ...
    importedMatchEmptyTitle: 'Noch kein externe Teamdaten-Feed verknüpft',
    ...
    manageImportedMatch: 'externe Teamdaten-Import verwalten',
    linkFussballTeam: 'externe Teamdaten-Team verknüpfen',
  ...
  fussball: {
    ...
    title: 'externe Teamdaten-Verknüpfung',
    subtitle:
      'Füge die öffentliche externe Teamdaten-Team-URL oder ID für {{team}} ein. Wir importieren Spiele, Orte, Platzadressen und Ergebnisse.',
    linkTitle: 'Team-Feed verknüpfen',
    linkBody:
      'Nutze eine öffentliche Team-URL oder die Team-ID von externe Teamdaten. Manuelle Eingaben sollen nur nötig sein, wenn die Quelle leer bleibt.',
    inputPlaceholder: 'URL der öffentlichen Teamseite oder Team-ID',
  ...
  more: {
    ...
    fussballLink: 'externe Teamdaten-Sync',
  ...
  onboarding: {
    ...
    clubCreate: {
      ...
      officialTeamUrlHelp: 'Füge die offizielle Teamseite des Wettbewerbsanbieters zur Prüfung deiner Berechtigung ein.',
