export default {
  ...
  notificationSettings: {
    ...
    description: 'Lege pro Mannschaft fest, welche Benachrichtigungen du erhältst. Vereinsweite Einstellungen gelten als Standard für alle Mannschaften.',
    clubWide: 'Alle Mannschaften (Standard)',
